...
export class OffchainAggregator__factory {
  static readonly abi = _abi;
  static createInterface(): OffchainAggregatorInterface {
    return new Interface(_abi) as OffchainAggregatorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): OffchainAggregator {
    return new Contract(address, _abi, runner) as unknown as OffchainAggregator;
  }
}
