...
export interface OffchainAggregatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LINK"
      | "acceptOwnership"
...
export interface OffchainAggregator extends BaseContract {
  connect(runner?: ContractRunner | null): OffchainAggregator;
